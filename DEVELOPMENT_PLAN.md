...
- **Application modularization:** Context menu, settings dialog, and tray adapter now live in `scripts/ui/`; Codex discovery/transport and safe diagnostic summaries now live in `scripts/api/`; main-window extraction remains staged work.
