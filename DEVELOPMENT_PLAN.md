...
- **Application modularization:** Context menu, settings dialog, and tray adapter now live in `scripts/ui/`; Codex discovery/transport now lives in `scripts/api/codex_transport_api.py`; main-window extraction remains staged work.
