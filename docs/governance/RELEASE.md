...
- Installed runtime: the supported installed product is a PyInstaller onedir EXE
  and requires no target-machine Python, pip, Git, or repository checkout. Python
  3.11 remains the CI baseline and Python 3.12.13 is locally verified for source
  development only.
