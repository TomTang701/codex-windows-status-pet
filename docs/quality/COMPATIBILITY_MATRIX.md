...
| Popup | Top, left, and right taskbar edges | Deferred / Not claimed / Non-blocking | These taskbar placements are not part of the v0.3.2 physical support claim; geometry API tests remain regression evidence only. |
