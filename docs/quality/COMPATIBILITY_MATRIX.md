...
| v0.4.1 content and errors | All 25 scale steps; tray/quota failure paths | Windows host and integration pass | [2026-07-11 v0.4.1 correctness record](test-records/2026-07-11-v0.4.1-correctness-validation.md); mapped actual/requested geometry fits all five rows, legacy Label-style calls are removed, approved error rows render, raw exception text is hidden, and tray recovery schedules once. |
