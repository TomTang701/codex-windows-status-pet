...
| v0.4.1 content and errors | All 25 scale steps; tray/quota failure paths | **Blocked — clipping test invalidated** | [2026-07-11 v0.4.1 correctness record](test-records/2026-07-11-v0.4.1-correctness-validation.md) is retained as false-positive evidence. A real production screenshot still shows Reset Credit clipping; DPI-faithful reproduction and a replacement contract are required. Error-path integration remains green but does not clear the layout blocker. |
