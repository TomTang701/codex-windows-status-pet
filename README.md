...
- Settings: opacity, one proportional Window Size slider (80–200%), font color, background color, default X/Y position, always-on-top, position lock, independent 5h/weekly/reset-credit row visibility, battery quota source, and a digit-only 1–10 second refresh interval.
