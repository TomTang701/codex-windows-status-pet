# ACTIVE VERSION BRIEF – v0.6.0 5H Battery Indicator and Layout Tightening
...
- `v0.5.5` is released and v0.6.0 is the active release candidate.
...
`PROGRAM ACTIVE / v0.6.0 CANDIDATE VERIFIED / PR NEXT`
