...
`v0.5.2 ACTIVE / DESIGN VERIFICATION PENDING / v0.6.0 BLOCKED`

No production geometry, DPI-order, font, padding, or height modification is permitted before the verification-authority audit, exact v0.5.1 RED, and Design Verification Gate pass.
