...
- Current task: convert the proven long-lived transition reproduction into an authoritative automated RED
...
- Next exact action: add and run the automated long-lived cold-start-to-toggle RED before production edits
