...
- Current task: write the focused deletion/merge implementation plan
...
- Blocker: `None`
- Next exact action: write and self-review the v0.5.0 plan, then add the negative source-boundary RED test before deleting code
